...
class MyFriendsViewController: UIViewController {
    ...
    extension MyFriendsViewController: UITableViewDelegate, UITableViewDataSource {
     ...
     func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.configure(imageName: "defaultChannel", title: Variables.friendsList.friendsListArray[indexPath.row][0], detail: Variables.friendsList.friendsListArray[indexPath.row][1])
        return cell
    }
}
